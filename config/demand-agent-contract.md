...
`lawradar-demand-observations-v1` construit pour ce signal. Il ne lit aucun
...
La V0 n’automatise aucune de ces sources, ne crée aucune clé API et ne dépense
rien. Une observation peut être ajoutée plus tard seulement si elle porte une
