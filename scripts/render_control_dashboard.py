...
def render_dashboard(index: dict[str, Any]) -> str:
    ...
    body = "".join(rows) or '<tr><td colspan="7">Aucun manifeste disponible.</td></tr>'
...
<section><h2>Derniers runs</h2><table><thead><tr><th>Type</th><th>Statut</th><th>Horodatage UTC</th><th>Durée</th><th>Entrées / sorties</th><th>Coût</th><th>Détail</th></tr></thead><tbody>{body}</tbody></table></section>
</main></body></html>'''
